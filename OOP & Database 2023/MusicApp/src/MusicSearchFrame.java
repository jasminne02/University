...
public class MusicSearchFrame extends JFrame{
    ...
    public MusicSearchFrame(){
        ...
        searchMusicGA.addActionListener(new GenreAuthorMusicSearchAction());
    ...
    class GenreAuthorMusicSearchAction implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            Vector<String> vector = new Vector<>(Queries.getMusicByGenreAndAuthorID(authorName, genre));
            resultList.setListData(vector);
            if(vector.size() == 0){
                JOptionPane.showMessageDialog(null, "No search result!");
            }
