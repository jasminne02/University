...
public class AllPlaylistsFrame extends JFrame {
    ...
    public AllPlaylistsFrame(){
        ...
        // gets all current user playlists
    ...
    class SelectAction implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            if(addMusicToPlaylist){
                ...
                // checks if current user is author of the selected music
                ...
                // checks if selected playlist is still existing
                if(Queries.getPlaylistId(allPlaylistsList.getSelectedValue(), Queries.getUserId(User.username)) == -1){
                    dispose();
